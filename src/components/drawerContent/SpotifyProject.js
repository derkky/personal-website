...
const SpotifyProject = () => {
    return (
        ...
        >
            ...
            <Typography>
                3.1 Identification of prevalent topics
            </Typography>

            <Box>
                3 images side by side here
                <Typography>
                    Fig 1. Topic 1: Love
                </Typography>
            ...
            <Typography>
                3.2 Relative prevalence of identified topics
            </Typography>
            ...
            <Typography>
                This suggests that most popular songs today are mainly about love.However, as mentioned above in section 3.1, street culture likely has an underlying influence on other topics.Hence, “Street culture” may be more influential than its relatively low mean proportion in Fig. 4 suggests.
            </Typography>

            <Box>
                <Typography>
                    3.3 Distribution of topics in songs
                </Typography>
            </Box>
            ...
            <Typography>
                5.1 Difficult to determine number of topics, K, for Latent Dirichlet Allocation
            </Typography>
            <Typography>
            ...
            <Typography>
                5.2 Bing Sentiment analysis lexicon is limited
            </Typography>
            <Typography>
